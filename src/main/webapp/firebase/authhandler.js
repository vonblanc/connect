...
button_token.click(function(){          //handle button click and call 
   ...
   var request_profileCreate={
	...
	firebase.auth().currentUser.getToken().then(function(token){
		...
		sendTokenToConnect(token,request_profileCreate);
...
var sendTokenToConnect= function(sendToken,request)
{
	$.ajax({
        ...
        url: 'http://localhost:8080/_ah/api/connectapi/v1/createProfile',
