...
public class AboutMe{
	...
	public static enum ServiceAvailability{
		
		AWAY(true,false),
		HOME(false,true),
		HOMEANDAWAY(true,true);
		...
		private ServiceAvailability(boolean away,boolean home)
		{
			this.away=away;
			this.home=home;
		}
	...
	{ 
       ...
       // try{
        ...
        finishTime=finishTimeDate;
	  	...
	  	this.serviceAvailability=aboutmeforms.getServiceAvailability();
	}
	...
	public ServiceAvailability getServiceAvailability()
	{
		...
		{
			this.serviceAvailability=ServiceAvailability.HOMEANDAWAY;
		}
